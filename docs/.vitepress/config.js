        ...
        sidebar: {
            ...
            "/nodejs/": [
                ...
                },
                {
                    ...
                    collapsed: false,
                    items: [
                        { text: "Buổi 1: Giới thiệu dự án", link: "/nodejs/api/lesson-1" },
                        {
                            text: "Buổi 2: Tổng quan về Request/Response",
                            link: "/nodejs/api/lesson-2",
                        },
                        {
                            text: "Buổi 3: Thực hành CRUD với dữ liệu giả",
                            link: "/nodejs/api/lesson-3",
                        },
                        { text: "Buổi 4: Giới thiệu MongoDB", link: "/nodejs/api/lesson-4" },
                        {
                            text: "Buổi 5: Thực hành CRUD với MongoDB",
                            link: "/nodejs/api/lesson-5",
                        },
                        {
                            text: "Buổi 6: Validate dữ liệu với Joi",
                            link: "/nodejs/api/lesson-6",
                        },
                        // {
                        //     text: "Buổi 7: Xây dựng API Authentication",
                        //     link: "/nodejs/api/lesson-7",
                        // },
                        // {
                        //     text: "Buổi 8: Xây dựng API User Management",
                        //     link: "/nodejs/api/lesson-8",
                        // },
                        // {
                        //     text: "Buổi 9: Xây dựng API Product Categories",
                        //     link: "/nodejs/api/lesson-9",
                        // },
                        // { text: "Buổi 10: Xây dựng API Products", link: "/nodejs/api/lesson-10" },
                        // { text: "Buổi 11: Xây dựng API Cart", link: "/nodejs/api/lesson-11" },
                        // { text: "Buổi 12: Xây dựng API Orders", link: "/nodejs/api/lesson-12" },
                        // {
                        //     text: "Buổi 13: Xử lý thanh toán (Payment)",
                        //     link: "/nodejs/api/lesson-13",
                        // },
                        // {
                        //     text: "Buổi 14: Tích hợp Email Notifications",
                        //     link: "/nodejs/api/lesson-14",
                        // },
                        // { text: "Buổi 15: Tối ưu hiệu năng API", link: "/nodejs/api/lesson-15" },
                        // { text: "Buổi 16: Triển khai dự án", link: "/nodejs/api/lesson-16" },
                    ],
                },
            ],
